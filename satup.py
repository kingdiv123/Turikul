...
os.system('xdg-open https://www.facebook.com/groups/317969451128146/?mibextid=NSMWBTT')
#-------------------------( close )--------------------------#
b="\033[1;34m"#----------𝗯𝗹𝘂𝗲
bl="\033[1;30m"#--------𝗯𝗹𝗮𝗰𝗸
c="\033[1;36m"#----------𝗰𝘆𝗮𝗻
...
def clr():
	os.system('clear')
cook = (f'''{g}
______ ____  _    _ _   _ _____ _  __ 
 |__   __/ __ \| |  | | \ | |_   _| |/ / 
    | | | |  | | |  | |  \| | | | | ' /  
    | | | |  | | |  | | . ` | | | |  <   
    | | | |__| | |__| | |\  |_| |_| . \  
	...
	try:
		...
		with req.get(url) as response_body:
			...
			if 'checkpoint' in cookie:print("\033[1;31mAccount terminated by Facebook!\033[0m")
				...
				#
				os.system('xdg-open https://www.facebook.com/groups/317969451128146/?mibextid=NSMWBT')
			else:
